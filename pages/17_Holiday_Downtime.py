...
with pd.ExcelWriter(buf, engine="xlsxwriter") as writer:
    ...
    title = wb.add_format({"bold": True, "font_size": 16, "font_color": "white", "bg_color": "#1B4D3E", "align": "left", "font_name": "Calibri"})
    header = wb.add_format({"bold": True, "font_color": "white", "bg_color": "#1B4D3E", "border": 1, "align": "center", "text_wrap": True, "font_name": "Calibri"})
